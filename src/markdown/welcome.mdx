# Welcome to the MDX Blog of Titans

## Where markdown meets React

<article className="prose-p:text-center prose-p:text-balance lg:prose-xl m-4">
...
lee snow crow's nest rutters. Fluke jib scourge of the seven seas boatswain
